...
function get_os_icon() {
  ...
  customize() {
    ...
    typeset -g POWERLEVEL9K_CUSTOM_OS_ICON_BACKGROUND=212
    typeset -g POWERLEVEL9K_HOST_FOREGROUND=$DEFAULT_DARK
    typeset -g POWERLEVEL9K_HOST_BACKGROUND=218
    typeset -g POWERLEVEL9K_USER_FOREGROUND=$DEFAULT_DARK
    typeset -g POWERLEVEL9K_USER_BACKGROUND=213
    ...
    typeset -g POWERLEVEL9K_DIR_ANCHOR_BACKGROUND=35
